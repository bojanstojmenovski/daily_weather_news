...
const Hourly = () => {
  ...
  return (
    <div className="hourly-div">
      {weatherData.city && ( <h1>Hourly Weather Report for <span className="city-name">{weatherData.city.name}</span></h1> )}
      ...
      {!weatherData.city && ( <p className="initial-msg" >Please enter a city in the Search bar to see the Hourly Weather Report</p> )}
      {weatherData.list && (
